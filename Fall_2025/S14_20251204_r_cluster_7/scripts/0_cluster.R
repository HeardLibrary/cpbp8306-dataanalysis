...
hdb_model <- hdbscan(iris[, 1:4], minPts = min_samples)
...
# Practice Exercises
####################
# 1. Load the 'mtcars' dataset and perform k-means clustering with k = 3. Visualize the clusters using ggplot2. Try other k-values and 
#    compare the results. 
# 2. Load the 'mtcars' dataset and perform Gaussian Mixture Model (GMM) clustering with G = 3. Visualize the clusters using ggplot2. 
#    Compare the cluster assignments with the actual 'cyl' variable.
