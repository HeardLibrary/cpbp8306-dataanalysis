...
# Model 2
co2_demographic_glm2 <- glm(log(co2_per_capita) ~ (vulnerability_2020 + log(gdp_capita_2020))*
                              (secular + inst_con + open_in_groups + prosocial + interest_politics + 
                               wellbeing + politic_engage + individual_rights + open_out_groups),
                            data = glm_input, family = "gaussian")
